...
public class ModelEvalReport extends AbstractXlsxView {
ModelAndView modelandview = new ModelAndView();
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workBook, HttpServletRequest request,
		...
		/*
		 * ExcelFile excelFile = (ExcelFile)model.get("excelFile"); List<String>
		 * predictionResult = (List<String>)model.get("results"); Map<String,Object>
		 * evaluationResult = (Map<String,Object>)model.get("evaluationResult");
		 */
		...
		if (".xlsx".equals(fileType)) {
			xlsxReport(session,excelFile, predictionResult, evaluationResult, workBook);
	...
	public void xlsxReport(HttpSession session,ExcelFile excelFile, List<String> predictionResult, Map<String, Object> evaluationResult,
			Workbook workBook) {
		try {
			XSSFWorkbook wb = new XSSFWorkbook(new ByteArrayInputStream(excelFile.getFileContent()));
			XSSFSheet sheet = wb.getSheetAt(0);

			XSSFSheet predictionSheet = (XSSFSheet) workBook.createSheet("Prediction Result");
			Row row;
			Cell cell;
			row = sheet.getRow(0);
	...
	/*private void xlsReport(ExcelFile excelFile, List<String> predictionResult, Map<String, Object> evaluationResult,
